function captainIDToName(captainID) {
...
function sidekickIDToName(sidekickID) {
...
function stadiumIDToName(stadiumID) {
...
function compareStatEquality(stat1, stat2) {
...
function itemIDAndAmountToName(itemID, itemAmount) {
...
function timeToString(timeParam) {
...
function matchDifficultyToString(difficultyLevel) {
...
module.exports = {captainIDToName, itemIDToName, stadiumIDToName, sidekickIDToName}